...
namespace Library
{
    public class DBConnect
    {
        ...
        //String SqlConnectString = "server=cis-mssql1.temple.edu;Database=fa20_3342_tug22941;User id=tug22941;Password=ahd7UGhaew";

        // Home Connection String - used for working from home using SSH Tunneling.
        String SqlConnectString = "server=127.0.0.1,5555;Database=fa20_3342_tug22941;User id=tug22941;Password=ahd7UGhaew";
